...
const Cart = () => {
  ...
  return (
    <div className="px-[6%]  py-10 md:px-[7%] overflow-hidden relative">
      <Link
        to={"/product"}
        className="flex  border-2 justify-center items-center absolute top-2 left-10 bg-slate-100 p-3 rounded-full hover:scale-125 transition-transform duration-300"
      >
      ...
      {cartList.length ? (
        <div className="w-full flex flex-col md:flex-row justify-around py-[10px]">
          ...
          <div className=" md:w-[400px] h-[500px] shadow-xl px-[2%] py-3 sticky top-10 rounded-md">
            ...
            <div className="w-full flex justify-center">
              <button className="bg-[#3B5D50] font-semibold py-2 text-center w-[70%] text-white font-Poppins tracking-wider rounded-s-full rounded-e-full hover:scale-110 transition-transform duration-300">
                Proceed to checkout
              </button>
            </div>
          </div>
        ...
        <div className="h-[80vh] flex flex-col gap-5 justify-center items-center ">
          <img src={cart} className="" width={200}></img>
          <p className=" text-xl">
